// Tener acceso a las rutas... Valida el acceso de los usuarios logeados
...
export const authGuard: CanActivateFn = (route, state) => {
  ...
  // Valida que la url este dentro de las consideradas
