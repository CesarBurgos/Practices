...
import { ClientesService } from './services/clientes-service'; // Asegúrate de que la ruta a tu servicio sea correcta
...
@Component({
  ...
  imports: [
    ...
    RouterLink,
    RouterLinkActive,
    CommonModule // Requerido para usar *ngIf en el HTML
  ],
