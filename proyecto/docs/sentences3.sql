...
COMMENT ON COLUMN CLIENTES_BIT.V_ACCION IS 'Campo de control que indica la Acción en el registro';
...
-- USER SQL
CREATE USER "APPUSER_DEV" IDENTIFIED BY "apppass"
    DEFAULT TABLESPACE "USERS"
    TEMPORARY TABLESPACE "TEMP"
    ACCOUNT UNLOCK ;

-- QUOTAS
GRANT DBA TO "APPUSER_DEV";

-- ROLES
ALTER USER "APPUSER_DEV" DEFAULT ROLE "DBA";

-- SYSTEM PRIVILEGES
alter session set current_schema = APPUSER_DEV;