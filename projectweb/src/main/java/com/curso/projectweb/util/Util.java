package com.curso.projectweb.util;

public class Util {
    public static Boolean OKSUCCESS = Boolean.TRUE;
    public static Boolean ERRORSUCCES = Boolean.FALSE;
    ...
    public static String LOGINFAIL = "Intendo de login Erróneo de Usuario";
    ...
    public static String ERRBUSSINESS = "Error de Negocio";
